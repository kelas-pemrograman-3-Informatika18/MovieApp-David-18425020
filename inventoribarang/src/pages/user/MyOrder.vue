        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              <div class="text-h6">Data Transaksi Movie</div>
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="aksi" :props="props">
              <q-btn :disable="props.row.status !== 2" label="Terima Barang" @click="confirm(props.row._id)" class="q-ml-sm" color="green" unelevated />
            </q-td>
          </q-tr>
        </template>
      </q-table>
...
export default {
  ...
  methods: {
    ...
    confirm (id) {
      this.$q.dialog({
        title: 'Konfirmasi',
        message: 'Apakah Anda Yakin Mengkonfirmasi',
        cancel: true,
        persistent: true
      }).onOk(() => {
        this.$axios.put(`order/konfirmasiorderuser/${id}`)
          .then((res) => {
            if (res.data.sukses) {
